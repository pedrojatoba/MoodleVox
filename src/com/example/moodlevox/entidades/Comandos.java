...
public class Comandos {
    ...
    public Comandos() {
        //Audios de Entrada
        audios.put(1001, "Bem vindo ao menu inicial do Moodle Voz. Diga. após o sinal. qual comando você deseja executar. 1. Disciplinas. 2. Mensagens.");
        ...
        audios.put(1111, "Acessando o menu de fóruns listados. Os Fóruns disponíveis são: 1. Problemas, e 2 API. Diga. após o sinal. Qual Fórum deseja acessar");
        audios.put(11111, "Você está no Fórum Problemas Para listar postagens Diga. após o sinal: 1. .Postagens. ");
        audios.put(111111, "Diga. após o sinal. Qual mensegem deseja postar.");
        audios.put(11112, "Você está no Fórum API Para listar postagens Diga. após o sinal: 1. .Postagens. ");
        audios.put(111121, "Diga. após o sinal. Qual mensegem deseja postar.");
        audios.put(112, "Acessando o menu de Semanas. Diga. após o sinal. Qual comando deseja executar. 1. Recursos");
        audios.put(1121, "Acessando  menu de Recursos, eles são: 1. Texto da semana, 2. Links e 3. Arquivos. Diga. após o sinal. qual comando você deseja executar");
        ...
        audios.put(11110, "Voltando para o menu de fóruns listados. Os Fóruns disponíveis são: 1 Problemas, e 2 API.  Diga. após o sinal. Qual Fórum deseja acessar");
        audios.put(111110, "Voltando para o Fórum Problemas Para listar postagens Diga. após o sinal: Postagens ou 1 ");
        audios.put(111120, "Voltando para o Fórum API Para listar postagens Diga. após o sinal: Postagens ou 1 ");
        audios.put(1120, "Voltando para o menu de Semanas. Diga. após o sinal. Qual comando deseja executar. 1. Recursos");
        audios.put(11210, "Voltando para o menu de recursos que são: 1. Texto da semana, 2. Links e 3. Arquivos. Diga. após o sinal. qual comando você deseja executar");
    }
